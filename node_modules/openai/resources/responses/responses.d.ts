...
export declare class Responses extends APIResource {
     ...
     * ```
     */
    compact(body?: ResponseCompactParams | null | undefined, options?: RequestOptions): APIPromise<CompactedResponse>;
}
